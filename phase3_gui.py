...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.instructions = Text(self, height=20, width=100, bg = "light cyan")
...
class CppRunnerGUI(Frame):
    ...
    def create_widgets(self):
        ...
        self.output_text = Text(self, height = 20, width = 100, bg = "light yellow")
        self.output_text.pack()

    def compile_and_run_cpp_program(self):
        compile_process = subprocess.Popen(["g++", "phase3.cpp", "-o", "a.exe"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
def open_d_rl():
    with open("d_rl.txt", 'r') as f:
        contents5 = f.read()
        text5.delete('1.0', END)
        text5.insert(END, contents5)

open_button5 = Button(second_frame, text="Open d_rl File", command=open_d_rl)
open_button5.pack()
text5 = Text(second_frame, height =20, width=60, bg = "light yellow")
text5.pack()

def open_i_rl():
    with open("i_rl.txt", 'r') as f:
        contents6 = f.read()
        text6.delete('1.0', END)
        text6.insert(END, contents6)

open_button6 = Button(second_frame, text="Open i_rl File", command=open_i_rl)
open_button6.pack()
text6 = Text(second_frame, height =20, width=60, bg = "light green")
text6.pack()


def open_d():
    with open("d_$.txt", 'r') as f:
        contents7 = f.read()
        text7.delete('1.0', END)
        text7.insert(END, contents7)

open_button7 = Button(second_frame, text="Open d_$ File", command=open_d)
open_button7.pack()
text7 = Text(second_frame, height =20, width=60, bg = "light yellow")
text7.pack()

def open_i():
    with open("i_$.txt", 'r') as f:
        contents8 = f.read()
        text8.delete('1.0', END)
        text8.insert(END, contents8)

open_button8 = Button(second_frame, text="Open i_$ File", command=open_i)
open_button8.pack()
text8 = Text(second_frame, height =20, width=60, bg = "light green")
text8.pack()
...
def open_output_file():
    with open("output.txt", 'r') as f:
        ...
        text9.insert(END, contents9)

open_button9 = Button(second_frame, text="Open output File", command=open_output_file)
open_button9.pack()
text9 = Text(second_frame, height =20, width=60, bg = "light yellow")
text9.pack()
